...
def node_fn(context, *args, **kwargs):
    ...
    robots = {
        "rmtt_1": {'tf_frame': 'rmtt_1', 'frequency': 20, 'takeoff_height': 0.0, 'time_to_takeoff': 0.0, 'waypoints': 'drone1_trajectory_angle_20.wps'},
        "rmtt_2": {'tf_frame': 'rmtt_2', 'frequency': 20, 'takeoff_height': 0.0, 'time_to_takeoff': 0.0, 'waypoints': 'drone2_trajectory_angle_20.wps'},
        }
